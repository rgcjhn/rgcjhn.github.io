...
import { Linkedin, Mail, ExternalLink, MoveUpRight, ChevronDown } from 'lucide-react';
...
const StatItem = ({ value, label }: { value: string; label: string }) => (
  <div>
    <div className="text-3xl sm:text-4xl lg:text-7xl text-white font-bold">{value}</div>
